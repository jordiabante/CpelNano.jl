...
# Init plots
p1 = plot(xlabel="signal noise level (sd)", ylabel="accuracy", ylim=(0.5, 1));
p2 = plot(xlabel="signal noise level (sd)", ylabel="precision", ylim=(0.5, 1));
p3 = plot(xlabel="signal noise level (sd)", ylabel="sensitivity", ylim=(0.5, 1));
p4 = plot(xlabel="signal noise level (sd)", ylabel="specificity", ylim=(0.5, 1));
