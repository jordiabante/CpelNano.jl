...
# Init plots
p1 = plot(xlabel="sensitivity (recall)", ylabel="precision", title="Nanopolish", xlim=(0.0, 1.0), ylim=(0.5, 1.0));
p2 = plot(xlabel="sensitivity (recall)", ylabel="precision", title="DeepSignal", xlim=(0.0, 1.0), ylim=(0.5, 1.0));
p3 = plot(xlabel="sensitivity (recall)", ylabel="precision", title="Megalodon", xlim=(0.0, 1.0), ylim=(0.5, 1.0));
