...
α, β = CpelNano.get_αβ_from_ϕ(ϕ, x); M = 50; pobs = 0.75; μ_m = 2.0; σ_m = 3.0; μ_u = -2.0; σ_u = 3.0; 
config = CpelNano.CpelNanoConfig(); config.max_em_iters = 100; config.max_em_init = 1;config.verbose = true;
