...
# Parameter vector
a = 0.5; b = -20.0; c = 5.0; ϕ = [a,b,c]; L = 100;

# Other parameters
x=CpelNano.RegStruct(); x.L=L; x.Nl=fill(1.0,x.L); x.ρl=rand(0.001:0.001:0.1,x.L); x.dl=fill(10.0,x.L-1); 
α,β = CpelNano.get_αβ_from_ϕ(ϕ,x); M = 5; pobs = 0.5; μ_m = 40.0; σ_m = 2.0; μ_u = 80.0; σ_u = 2.0; 
config = CpelNano.CpelNanoConfig(); config.max_em_iters = 30; config.max_em_init = 2;config.verbose = true;
